...
import LogoStyle from "./Header.module.css";
...
export default function Header(props) {
    ...
    <Link href="/">
      ...
      >
        ...
        <div>
          ...
          <p className={LogoStyle.logo_sub_title}>
            A ESPORTS MANAGEMENT SOLUTION
          </p>
        </div>
      </div>
    </Link>
  ...
  return (
    <AppBar  data-aos="fade-down" className={appBarClasses}>
