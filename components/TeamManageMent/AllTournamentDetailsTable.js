...
import RoadMap from "./../../pages/tournament/roadMap";
...
const AllTournamentDetailsTable = ({ tournaments, reload }) => {
  ...
  let tableColumnsName = "AllTournamentDetailsTableColumns";
  ...
  const headerCell = [
    ...
    { label: "RoadMap", value: roadMap, registerName: "roadMap" },
    { label: "Team Count", value: teams, registerName: "teams" },
    { label: "Tour Status", value: tourStatus, registerName: "tourStatus" },
  ];
        ...
        <TableContainer className={classes.containerFluid}>
                  ...
                  .map((item, i) => {
                    return (
                      ...
                      >
                          ...
                          <StyledTableCell align="left">
                            {reload ? (
                              <LoadingSkeleton />
                                ...
                                <Link
                                href={{
                                  pathname: `/tournament/teamManagement/[tourId]/`,
                                  query: { tourId: item._id },
                                }}
                              >
                                <a>{  item?.tournament_Title}</a>
                              </Link>
                        ...
                        {roadMap && (
                          <StyledTableCell
                            onClick={() => handleRoadMapView(item)}
                            align="left"
                          >
                            {reload ? (
                              <LoadingSkeleton />
                            ) : (
                              <LightTooltip title="RoadMap" placement="top">
                                <Chip
                                  color="primary"
                                  style={{
                                    margin: "1px",
                          ...
                          <StyledTableCell align="left">
                            {reload ? (
                              ...
                              <Chip
                                ...
                                key={item?.roadMap.length}
                                label={handleFindTourStatus(item)}
                                className={classes.chip}
                              />
                            )}
                          </StyledTableCell>
          ...
          {tournaments.length <= 0 && (
            <h4
              ...
              className={classes.title}
            >
              No Tournaments available with RoadMap . Add Road To Your
              Tournament to add Teams.
            </h4>
          )}
        </TableContainer>
        <TablePagination
...
export default AllTournamentDetailsTable;
